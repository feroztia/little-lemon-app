...
const reviews = [
    {image: images.valeriia, name: "Valeriia", reviewText: "Review rext rext lorem ipsudolar"},
    {image: images.alexandra, name: "Alexandra", reviewText: "Review rext rext lorem ipsudolar"},
    {image: images.zhanna, name: "Zhanna", reviewText: "Review rext rext lorem ipsudolar"},
    {image: images.svitlana, name: "Svitlana", reviewText: "Review rext rext lorem ipsudolar"},
]
